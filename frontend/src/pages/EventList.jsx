...
export default function EventList() {
  ...
  return (
    <div style={{ maxWidth:'900px', margin:'0 auto', padding:'32px 24px' }}>
      ...
      {toast && (
        <div style={{ position:'fixed', top:'76px', right:'24px', background:'var(--bg2)', border:'1px solid var(--border)', borderRadius:'var(--radius-sm)', padding:'12px 18px', fontSize:'13px', zIndex:200, boxShadow:'0 4px 20px rgba(0,0,0,0.4)' }} className="fade-in">
          {toast}
        </div>
      )}
